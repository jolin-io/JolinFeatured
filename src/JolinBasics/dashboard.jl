...
using Jolin, HypertextLiteral, CSV, DataFrames
...
output_below()  # from Jolin.JolinPluto

# ╔═╡ 11b2cf52-fc74-4f7d-85be-0a5cb42394a4
TableOfContents()  # from Jolin.PlutoUI
...
# ╠═╡ show_logs = false
output = begin
	trace1 = scatter(;x=subdata1[!, xaxis], y=subdata1[!, yaxis], name=country1)
	trace2 = scatter(;x=subdata2[!, xaxis], y=subdata2[!, yaxis], name=country2)
    layout = Layout(;title="CO2 data",
                     xaxis=attr(title=xaxis, showgrid=false),
                     yaxis=attr(title=yaxis))
...
# ╔═╡ 25fbd848-3091-40db-81fc-3a4baa2a6711
cells = [1,2]  # second and third cell of the notebook

# ╔═╡ 161f1314-a8c6-4eaa-80db-361c27bfcfbd
md"""
...
suffix_cells = join("&isolated_cell=$i" for i in cells)

# ╔═╡ 2c4135c4-bacf-4a46-adb6-b861aa08d73d
md"""
...
link_view = @htl """👉 <a href="$url_open$suffix_cells" target="_blank">
open dedicated view
</a>"""
...
manifest_format = "2.0"
project_hash = "bfde21d6fbf4a4548fb1a8ac6e14aecd7e993f48"
